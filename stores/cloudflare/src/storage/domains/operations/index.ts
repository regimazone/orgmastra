...
import { ensureDate, serializeDate, StoreOperations, TABLE_EVALS, TABLE_MESSAGES, TABLE_SCORERS, TABLE_THREADS, TABLE_TRACES, TABLE_WORKFLOW_SNAPSHOT } from '@mastra/core/storage';
...
export class StoreOperationsCloudflare extends StoreOperations {
    ...
    constructor({ namespacePrefix, bindings, client, accountId }: {
        ...
        namespacePrefix: string, client?: Cloudflare, accountId?: string
    }) {
        super();
