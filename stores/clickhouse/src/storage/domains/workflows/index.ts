...
export class WorkflowsClickHouse extends WorkflowsStorage {
    ...
    try {
      ...
      if (limit !== undefined && offset !== undefined) {
        const countResult = await this.client.query({
          query: `SELECT COUNT(*) as count FROM ${TABLE_WORKFLOW_SNAPSHOT} ${whereClause}`,
          query_params: values,
          format: 'JSONEachRow',
        });
