...
export class MemoryStorageClickhouse extends MemoryStorage {
    ...
    async getMessagesPaginated(
        ...
        try {
            ...
            const perPage = perPageInput !== undefined ? perPageInput : resolveMessageLimit({ last: selectBy?.last, defaultLimit: 20 });
    ...
    async getResourceById({ resourceId }: { resourceId: string }): Promise<StorageResourceType | null> {
        try {
            ...
            return {
                id: resource.id,
                workingMemory: resource.workingMemory && typeof resource.workingMemory === 'object'
