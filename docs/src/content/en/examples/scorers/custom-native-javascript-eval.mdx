...
import { wordInclusionScorer } from "./mastra/scorers/example-word-inclusion";
...
`WordInclusionScorer` returns a result in the following shape:
...
<GithubLink
  marginTop='mt-16'
  link="https://github.com/mastra-ai/mastra/blob/main/examples/basics/scorers/word-inclusion"
/>
