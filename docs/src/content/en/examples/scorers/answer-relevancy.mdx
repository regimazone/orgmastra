...
```
> See [AnswerRelevancyScorer](/reference/scorers/answer-relevancy.mdx) for a full list of configuration options.

## Understanding the results

`AnswerRelevancyScorer` returns a result in the following shape:
