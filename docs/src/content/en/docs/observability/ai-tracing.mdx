...
- ✅ [LangSmith](https://langsmith.langchain.com/) - RunTree-based integration
...
The LangSmith exporter sends trace data to [LangSmith](https://langsmith.langchain.com/) for AI observability and debugging using LangSmith's native RunTree API.
...
type LangSmithExporterConfig = {
  ...
  // LangSmith project name (optional - defaults to 'mastra-tracing')
  projectName?: string;
  ...
  // Additional options passed to the LangSmith client
  options?: any;
};
```
