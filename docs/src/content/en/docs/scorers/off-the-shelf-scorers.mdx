...
- [`multimodal-relevance`](/reference/scorers/multimodal-relevance): Evaluates relevance of responses to multimodal contexts including text, images, or both (`0-1`, higher is better)
