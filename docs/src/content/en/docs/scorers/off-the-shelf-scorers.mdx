...
- [`multimodal-faithfulness`](/reference/scorers/multimodal-faithfulness): Evaluates factual accuracy of responses against multimodal contexts including text, images, or both (`0-1`, higher is better)
