...
export function generateObjectTestsV4({ executeFn, runId }: { executeFn: typeof execute; runId: string }) {
  const generateObject = async (
    ...
    return result.aisdk.v4.getFullOutput();
  };

  describe('generateObject', () => {
    describe('output = "object"', () => {
      describe('result.object', () => {
        it.only('should generate object with json mode', async () => {
