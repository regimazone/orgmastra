 ...
 */
declare function parseJSON(options: { text: string; schema?: undefined }): any;
 ...
 */
declare function safeParseJSON(options: { text: string; schema?: undefined }): ParseResult<any>;
/**
 ...
 */
declare function safeParseJSON<T>(options: { text: string; schema: ZodSchema<T> | Validator<T> }): ParseResult<T>;
...
declare const createStatusCodeErrorResponseHandler: () => ResponseHandler<any>;
...
declare const postJsonToApi: <T>({
  ...
  headers?: Record<string, string | undefined>;
  body: unknown;
  failedResponseHandler: ResponseHandler<any>;
  successfulResponseHandler: ResponseHandler<T>;
  abortSignal?: AbortSignal;
  fetch?: FetchFunction;
}) => Promise<{
