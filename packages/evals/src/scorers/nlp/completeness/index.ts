...
interface CompletenessScorerResult extends CodeScorerScoreResult {
  info: {
...
export class CompletenessScorer extends CodeScorer {
  name = 'Completeness Scorer';
  description = 'A scorer that evaluates the completeness of an output with respect to an input';

  async score({ input, output }: { input: string; output: string }): Promise<CompletenessScorerResult> {
